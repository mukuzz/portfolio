...
export default function Intro() {
  ...
  return (
    <section ref={ref} className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]" id="home">
      ...
      <motion.div className="flex flex-row flex-wrap gap-2 items-center justify-center px-4 font-medium"
      ...
      >
        ...
        <div className="flex flex-row flex-wrap gap-2 items-center justify-center">
          <a className="bg-white p-4 text-gray-700 flex items-center gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer border border-black/10" href="https://github.com/mukuzz" target="_blank">
            <BsGithub />
          </a>
          ...
          <a className="bg-white p-4 text-gray-700 flex items-center gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer border border-black/10" href="https://x.com/mukuz_" target="_blank">
            <BsTwitter />
          </a>
        </div>
      </motion.div>
